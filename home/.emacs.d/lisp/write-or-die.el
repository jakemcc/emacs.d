...
(defcustom write-or-die-target-time 1200
  "The target time (in seconds) for which you want to write after write-or-die-go is invoked."
  :group 'write-or-die)
(defcustom write-or-die-progress-format " [%s of %s, TIMER: %s]"
  "A format string that controls how your current progress is displayed"
  :group 'write-or-die)
...
(defun write-or-die-update ()
  "This is called every second, and updates word count etc. / calls warning routine or stimulus routine."
